  ...
  return (
    <div className="flex flex-col w-full items-center h-full overflow-hidden">
      <div className="overflow-y-auto h-full w-full p-6 lg:p-12 flex justify-center flex-col items-center">
        <h1 className="mt-6 text-3xl font-extrabold text-center lg:hidden">
          💰BudgetAI
        </h1>
        <Card
          className={`w-full max-w-md mt-3 ${
            type === 'sign-up' ? 'lg:mt-40' : ''
          } max-h-max`}
        >
          <CardHeader>
                  ...
                  {type === 'sign-up' && (
                    <>
                      ...
                      <CustomInput
                        ...
                        name="address"
                        label="Dirección"
                        placeholder="Ingresa una dirección específica"
                      />
                      <CustomInput
                        control={form.control}
                        name="city"
                        label="Ciudad"
                        placeholder="Ingresa tu ciodad"
                      />
                      <div className="flex gap-4">
                        <CustomInput
                          control={form.control}
